...
else
{
		...
		else if ((strcmp($get_field_1 ,"noball" )==0) or  (strcmp($get_field_1 ,"wide" )==0) )
		{
			...
			mysqli_query($conn,"UPDATE live_score SET  field_12 =field_12+'$get_extra', 
					field_13 = field_13+'1'
		...
		mysqli_query($conn,"UPDATE live_score SET  field_12 =field_12+'$get_field_1', 
				  field_13 = field_13+'$get_ball',field_14 = field_14+'$get_out_count'
